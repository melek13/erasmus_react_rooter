...
function Basvuru_goruntule(props){
    ...
    return(
      ...
      <div class="row" style={{justifyContent :'end'}}>
        ...
        <div class="col-2">
          <button type="submit" class="btn btn-success " style={{backgroundColor: '#0144a8'}} > Düzenle </button>
        </div>
      </div>      
    </div>
...
export default Basvuru_goruntule;